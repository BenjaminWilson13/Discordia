    ...
    <>
      ...
      <div id="conversations-container" className="channel-list-scroll">
          ...
          return (
            <div key={name}>
              ...
              >
                {name}
                <OpenModalButton
                  id={`new-channel-button-${name}`}
                  buttonText={<i className="fa-solid fa-plus add-channel"></i>}
                  className={"hidden"}
                  modalComponent={
                    <CreateChannelModal
              ...
              {Object.keys(channels[name]).map((channelName) => {
                return (
                  <div
                    ...
                    onClick={() =>
                      history.push(
                        `/channels/${serverId}/${channels[name][channelName].id}`,
                      )
                    }
                  >
                    <span
                      id="channel"
                      style={
                        channelName === serverDisplay.channelIds[channelId] &&
                    ...
                    <OpenModalButton
                      id={`channel-edit-${channelName}`}
                      buttonText={
                        <i
                          className="fa-solid fa-gear"
                          style={{
                            backgroundColor: "var(--channel-hover)",
                            fontSize: ".8rem",
                          }}
                        ></i>
                      }
        ...
        <div
          ...
          onMouseOver={(e) => {
            const button = document.getElementById(
              `new-channel-button-voice-channels`,
            );
            button.className = "edit-channel-name-button";
          }}
          onMouseLeave={(e) => {
        ...
        >
          Voice Channels
          <OpenModalButton
            id={`new-channel-button-voice-channels`}
            buttonText={<i className="fa-solid fa-plus add-channel"></i>}
            className={"hidden"}
            modalComponent={
              <CreateChannelModal
          ...
          return (
            <div key={channelName}>
              <div
                ...
                onClick={() =>
                  history.push(`/voiceChannel/${serverId}/${voiceChannel.id}`)
                }
              >
                <span
                  id="channel"
                ...
                >
                  <i className="fa-phone-volume fa-solid"></i> {channelName}
                </span>
                <OpenModalButton
                  id={`channel-edit-${channelName}`}
                  buttonText={
