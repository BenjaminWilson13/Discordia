            ...
            <div id="create-server-container">
                ...
                <form className="form-box" onSubmit={handleSubmit}>
                    ...
                    <label className="create-server-label">
                        Channel Name
                        <input type="text" className="input-area" onKeyPress={handleEnter} maxLength="25" minLength="5" value={name} onChange={(e) => setName(e.target.value)} required />
                    </label>
                    <div className="delete-server-buttons">
                        <button id="delete-edit-button" className="delete-button" onClick={deleteVoiceChannelFunction}>Delete Channel</button>
